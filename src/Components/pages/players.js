...
const Players = () => {
    ...
    const tr1  = [td1, td2, td3, td4, edit]
    const tbody= [tr1, tr1, tr1, tr1, tr1,tr1, tr1, tr1]
    return <div className="p-10"><SortedTable header={header} footer={footer} list={list} tbody={tbody} /></div>
}
